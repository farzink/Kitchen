        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Kitchens_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CokkingTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishCategoryRecipe", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DishCategoryRecipe_DishCategories_DishCategoryId",
                        column: x => x.DishCategoryId,
                        principalTable: "DishCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DishCategoryRecipe_Recipes_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishCategoryRecipe_DishCategoryId",
                table: "DishCategoryRecipe",
                column: "DishCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_DishCategoryRecipe_RecipeId",
                table: "DishCategoryRecipe",
                column: "RecipeId");
